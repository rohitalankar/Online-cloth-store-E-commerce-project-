...
$customers=mysqli_query($con,"select * from customers");
   $count_customers = mysqli_num_rows($customers);
$product_category=mysqli_query($con,"select * from product_categories");
   $count_product_category = mysqli_num_rows($product_category);
$pending=mysqli_query($con,"select * from pending_orders");
        ...
        <div class="panel panel-red"><!-- panel panel-red begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo$count_pending; ?> </div>
